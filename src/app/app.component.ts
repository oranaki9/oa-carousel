...
export class AppComponent {
  ...
  items: any[] = [
    { name: 'Or Anaki', title: 'I am a fucking genious' },
    { name: 'Ben Ari Kutai', title: 'I am a fucking ,....' }
  ];
  onNext(currentIndex: number) {
    console.log("AppComponent -> onNext -> num", currentIndex)

  }
  onPrev(currentIndex: number) {
    console.log("AppComponent -> onPrev -> num", currentIndex)
  }
}
